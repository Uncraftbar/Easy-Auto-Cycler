...
> **Branch: `neoforge-26.2`** — NeoForge 26.2 with [Easy Villagers](https://www.curseforge.com/minecraft/mc-mods/easy-villagers) and [Trade Cycling](https://www.curseforge.com/minecraft/mc-mods/trade-cycling) support.
...
- **Minecraft:** 26.2
- **Mod Loader:** [NeoForge](https://neoforged.net/) 26.2+
- **Java:** 25
- **One of:**
...
|--------|--------|------------|----------------|
| **`neoforge-26.2`** | **NeoForge** | **26.2** | **Easy Villagers, Trade Cycling** |
